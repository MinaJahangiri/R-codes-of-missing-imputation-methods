...
##########################################################
# Imputation for trajectory of bmi variable using copyMean.local
##########################################################
bmi<-B[,3:8]
names(bmi)
head(bmi)
...
imp.bmi<-imputation(bmi.traj,method="copyMean.local",lowerBound="globalMin",upperBound="globalMax")
...
##########################################################
# Imputation for trajectory of dbp variable using copyMean.local
##########################################################
dbp<-B[,9:14]
names(dbp)
head(dbp)
...
imp.dbp<-imputation(dbp.traj,method="copyMean.local",lowerBound="globalMin",upperBound="globalMax")
...
##########################################################
# Imputation for trajectory of sbp variable using copyMean.local
##########################################################
sbp<-B[,15:20]
names(sbp)
head(sbp)
...
imp.sbp<-imputation(sbp.traj,method="copyMean.local",lowerBound="globalMin",upperBound="globalMax")
