...
##########################################################
# Imputation for trajectory of bmi variable using crossMedian
##########################################################
bmi<-B[,3:8]
names(bmi)
head(bmi)
...
imp.bmi<-imputation(bmi.traj,method="crossMedian",lowerBound="globalMin",upperBound="globalMax")
bmi<-as.data.frame(imp.bmi)
head(bmi)
tail(bmi)

##########################################################
# Imputation for trajectory of dbp variable using crossMedian
##########################################################
dbp<-B[,9:14]
names(dbp)
head(dbp)
...
imp.dbp<-imputation(dbp.traj,method="crossMedian",lowerBound="globalMin",upperBound="globalMax")
dbp<-as.data.frame(imp.dbp)
head(dbp)
tail(dbp)

##########################################################
# Imputation for trajectory of sbp variable using crossMedian
##########################################################
sbp<-B[,15:20]
names(sbp)
head(sbp)
...
imp.sbp<-imputation(sbp.traj,method="crossMedian",lowerBound="globalMin",upperBound="globalMax")
