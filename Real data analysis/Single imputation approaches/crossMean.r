...
##########################################################
# Imputation for trajectory of bmi variable using crossMean
##########################################################
bmi<-B[,3:8]
names(bmi)
head(bmi)
...
imp.bmi<-imputation(bmi.traj,method="crossMean",lowerBound="globalMin",upperBound="globalMax")
bmi<-as.data.frame(imp.bmi)
head(bmi)
tail(bmi)

##########################################################
# Imputation for trajectory of dbp variable using crossMean
##########################################################
dbp<-B[,9:14]
names(dbp)
head(dbp)
...
imp.dbp<-imputation(dbp.traj,method="crossMean",lowerBound="globalMin",upperBound="globalMax")
dbp<-as.data.frame(imp.dbp)
head(dbp)
tail(dbp)

##########################################################
# Imputation for trajectory of sbp variable using crossMean
##########################################################
sbp<-B[,15:20]
names(sbp)
head(sbp)
...
imp.sbp<-imputation(sbp.traj,method="crossMean",lowerBound="globalMin",upperBound="globalMax")
