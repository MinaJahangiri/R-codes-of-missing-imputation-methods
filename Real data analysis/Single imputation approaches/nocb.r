...
##########################################################
# Imputation for trajectory of bmi variable using nocb
##########################################################
bmi<-B[,3:8]
names(bmi)
head(bmi)
...
imp.bmi<-imputation(bmi.traj,method="nocb",lowerBound="globalMin",upperBound="globalMax")
...
##########################################################
# Imputation for trajectory of dbp variable using nocb
##########################################################
dbp<-B[,9:14]
names(dbp)
head(dbp)
...
imp.dbp<-imputation(dbp.traj,method="nocb",lowerBound="globalMin",upperBound="globalMax")
...
##########################################################
# Imputation for trajectory of sbp variable using nocb
##########################################################
sbp<-B[,15:20]
names(sbp)
head(sbp)
...
imp.sbp<-imputation(sbp.traj,method="nocb",lowerBound="globalMin",upperBound="globalMax")
