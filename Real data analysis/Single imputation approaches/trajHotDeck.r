...
##########################################################
# Imputation for trajectory of bmi variable using trajHotDeck
##########################################################
bmi<-B[,3:8]
names(bmi)
head(bmi)
...
imp.bmi<-imputation(bmi.traj,method="trajHotDeck",lowerBound="globalMin",upperBound="globalMax")
bmi<-as.data.frame(imp.bmi)
head(bmi)
tail(bmi)

##########################################################
# Imputation for trajectory of dbp variable using trajHotDeck
##########################################################
dbp<-B[,9:14]
names(dbp)
head(dbp)
...
imp.dbp<-imputation(dbp.traj,method="trajHotDeck",lowerBound="globalMin",upperBound="globalMax")
dbp<-as.data.frame(imp.dbp)
head(dbp)
tail(dbp)

##########################################################
# Imputation for trajectory of sbp variable using trajHotDeck
##########################################################
sbp<-B[,15:20]
names(sbp)
head(sbp)
...
imp.sbp<-imputation(sbp.traj,method="trajHotDeck",lowerBound="globalMin",upperBound="globalMax")
