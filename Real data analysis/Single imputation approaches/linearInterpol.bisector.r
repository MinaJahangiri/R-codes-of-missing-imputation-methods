...
##########################################################
# Imputation for trajectory of bmi variable using linearInterpol.bisector
##########################################################
bmi<-B[,3:8]
names(bmi)
head(bmi)
...
imp.bmi<-imputation(bmi.traj,method="linearInterpol.bisector",lowerBound="globalMin",upperBound="globalMax")
...
##########################################################
# Imputation for trajectory of dbp variable using linearInterpol.bisector
##########################################################
dbp<-B[,9:14]
names(dbp)
head(dbp)
...
imp.dbp<-imputation(dbp.traj,method="linearInterpol.bisector",lowerBound="globalMin",upperBound="globalMax")
...
##########################################################
# Imputation for trajectory of sbp variable using linearInterpol.bisector
##########################################################
sbp<-B[,15:20]
names(sbp)
head(sbp)
...
imp.sbp<-imputation(sbp.traj,method="linearInterpol.bisector",lowerBound="globalMin",upperBound="globalMax")
