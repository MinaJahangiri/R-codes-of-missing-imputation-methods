...
write.table(as.data.frame(do.call(rbind, data1)),"simulation.miceadds.pmm.csv",sep=",",col.names=T,row.names=F)
A<-read.csv("simulation.miceadds.pmm.csv",header=TRUE,na.string="NA")
